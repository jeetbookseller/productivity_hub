...
- Test Suite (26 tiered deterministic tests: `T0=10`, `T1=9`, `T2=8`, with 3-run flake consistency gate), Export/Import, Theme (default: System), cohesive dark mode; modal exit animations, debounced writes, tab/item transitions
